...
# 53 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\pic\include\proc\pic18f2550.h"
...
if (dato & (1<<4)) LATCbits.LATC0 = 1; else LATCbits.LATC0 = 0;
if (dato & (1<<5)) LATCbits.LATC1 = 1; else LATCbits.LATC1 = 0;
if (dato & (1<<6)) LATCbits.LATC2 = 1; else LATCbits.LATC2 = 0;
if (dato & (1<<7)) LATBbits.LATB3 = 1; else LATBbits.LATB3 = 0;
LATAbits.LATA3 = 1;
__nop();
LATAbits.LATA3 = 0;
