...
void LCD_write_nible(unsigned char nible)
{
    ...
    if (nible & (1<<1)) LATCbits.LC1 = 1; else LATCbits.LC1 = 0;
    if (nible & (1<<2)) LATCbits.LC2 = 1; else LATCbits.LC2 = 0;
    if (nible & (1<<3)) LATBbits.LB4 = 1; else LATBbits.LB4 = 0;
    LATAbits.LA3 = 1;
    __nop(); __nop();
    LATAbits.LA3 = 0;
}
