 ...
 * Descripcion  Para el manejo de LCD para PIC18
...
#define RS          LATAbits.LA2          //Pin 4 LCD
#define EN          LATAbits.LA3          //Pin 6 LCD

#define D4          LATCbits.LC0          //Pin 11 lcd         
#define D5          LATCbits.LC1          //Pin 12 lcd            
#define D6          LATCbits.LC2          //Pin 13 lcd               
#define D7          LATBbits.LB4          //Pin 14 lcd
...
#define TRIS_D7          TRISBbits.TRISB4          //Pin 14 lcd
...
void LCD_char(unsigned char caracter);           //Envia caracteer a LCD
void LCD_write_text(unsigned char *dato);
...
void LCD_char(unsigned char caracter)
{   
    RS = 1; 
